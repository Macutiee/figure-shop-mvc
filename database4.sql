...
INSERT INTO `orders` (`id`, `customer_name`, `customer_phone`, `customer_address`, `customer_note`, `total_price`, `status`, `created_at`) VALUES
	...
	(4, 'Võ Hoàng Yến', '0999999999', '12 Hồ Hoàn Kiếm', '', 10200000, 'completed', '2026-03-25 07:02:49'),
	(5, 'Ma', '0111222333', '123 Bình Dương', 'Chống sốc kỹ vô nha', 14000000, 'cancelled', '2026-03-25 07:05:12'),
	(6, 'Ma', '0123456789', '123 Hồ Chí Minh', '', 3550000, 'completed', '2026-03-25 07:34:53');
...
INSERT INTO `products` (`id`, `name`, `price`, `old_price`, `brand`, `image`, `stock`, `sold_count`, `is_flash_sale`) VALUES
	...
	(2, 'Ookami to Koushinryou: Merchant Meets the Wise Wolf - Holo', 1200000, 0, 'Good Smile', 'https://otakustore.vn/image/cache/catalog/2024/05/ookami-to-koushinryou-merchant-meets-the-wise-wolf-holo-pop-up-parade-2024-ver-good-smile-company-1-750x750h.jpg', 9, 0, 0),
...
INSERT INTO `users` (`id`, `fullname`, `email`, `password`, `phone`, `avatar`, `role`, `created_at`) VALUES
	(1, 'Macutiee', 'baoloann2906@gmail.com', '$2y$10$3zOQv2GF35SMT5v.4EMaa..5ComJpue4XiUly9jY42nswIn9xqgfe', '0123456789', 'uploads/avatars/user-1-1774974468.gif', 'customer', '2026-03-25 07:33:54'),
	(2, 'Admin', 'baoloann2811@gmail.com', '$2y$10$dbuMiPoK68ughYR0e49Jr.yEvJqRyLlGIWGMGhrog/OrGgtM8.KEm', '0111222333', 'uploads/avatars/user-2-1774973968.jpg', 'admin', '2026-03-25 07:35:29'),
	(3, 'Long', 'long@gmail.com', '$2y$10$/KWKTN5puB43Jj/tJAZZeucgJaYKtilm.FUYWxNmhIpqEKaQbV5Ke', '0123123123', NULL, 'customer', '2026-03-31 14:51:35'),
	(4, 'Xa Xiu', 'xiu@gmail.com', '$2y$10$KZaOcWawpZ.AJGOk/FsZXugWHE2eoUVaO5w0owYY/7Kh82ob8Dehm', '0987654321', NULL, 'customer', '2026-03-31 14:52:42');
